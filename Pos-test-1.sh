...
echo "======================================"
echo "Applying libheif dependency fix"
echo "======================================"

sed -i '/^[[:space:]]*"libheif",[[:space:]]*$/d' vendor/xiaomi/sm8450-common/Android.bp

if grep -q '^[[:space:]]*"libheif",[[:space:]]*$' vendor/xiaomi/sm8450-common/Android.bp; then
    echo "ERROR: libheif dependency was not removed"
    exit 1
fi

echo "libheif dependency removed successfully"
